...
<body class="bg-dark">
    <div class="container mt-5 bg-light rounded p-5 col-lg-8">
        <h1 class="mb-4">Seguridad: Ataque XSS</h1>
        <p>
            ...
            Objetivo: Simular un ataque XSS a aun sitio web vulnerable para instalar un keylogger y obtener información sensible.
        </p>
        <p>
        ...
        <p>
            ...
            <br>
            Un keylogger es un software o dispositivo que registra secretamente cada pulsación de teclas en una computadora o dispositivo móvil, capturando contraseñas, información personal y datos bancarios para enviarlos a un tercero. 
            <br>
            Son una forma peligrosa de spyware que puede usarse para cometer fraude, robo de identidad y otros delitos. 
        </p>
        <p>
            ...
            El ataque consiste en aprovechar una vulnerabilidad del sitio web de la víctima y mediante <strong>inyección JavaScript</strong> en el formulario de comentarios se coloca un fragmento de código malicioso (keylogger), que luego es ejecutado por el sitio al mostrar los comentarios.
        </p>
        <hr>
